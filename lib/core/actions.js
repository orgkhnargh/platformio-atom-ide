...
export const UPDATE_FLAG_VALUE = 'UPDATE_FLAG_VALUE';
...
export const updateFlagValue = (key, value) => action(UPDATE_FLAG_VALUE, { key, value });
export const updateError = (key, value) => action(UPDATE_ERROR, { key, value });
