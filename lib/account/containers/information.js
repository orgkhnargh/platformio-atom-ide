...
import { accountInfoUpdateRequest, authFormOpenRequest } from '../actions';
import { getAccountInformation, getAccountInformationUpdateInProgress, getIsLoggedIn } from '../selectors';
...
class InformationPage extends React.Component {
  ...
  static propTypes = {
    ...
    refreshInfo: PropTypes.func.isRequired,
    info: PropTypes.object,
    isLoggedIn: PropTypes.bool.isRequired,
    accountInformationUpdateInProgress: PropTypes.bool.isRequired,
  }
  ...
  render() {
    if (this.props.accountInformationUpdateInProgress) {
      return (
      ...
      return <AccountInfo refreshInfo={ this.props.refreshInfo } data={ this.props.info } />;
    } else {
...
function mapStateToProps(state) {
  return {
    ...
    accountInformationUpdateInProgress: getAccountInformationUpdateInProgress(state),
  };
}
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators({
    ...
    onCreateAccountClick: () => authFormOpenRequest(REGISTER_FORM),
    refreshInfo: accountInfoUpdateRequest,
  }, dispatch);
}
