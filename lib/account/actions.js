...
export const TOKEN_FETCH_FORM_CLOSE_REQUEST = 'TOKEN_FETCH_FORM_CLOSE_REQUEST';
...
export const tokenFetchFormCloseRequest = () => action(TOKEN_FETCH_FORM_CLOSE_REQUEST);
